...
export const InternshipHistory: React.FC<InternshipHistoryProps> = ({
  internships,
}) => {
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        {filteredInternships.length > 0 ? (
          filteredInternships.map((internship) => (
            <div
              key={internship.id}
              className="flex items-center justify-between p-6 hover:bg-gray-50 dark:hover:bg-gray-800/50"
            >
              <div>
