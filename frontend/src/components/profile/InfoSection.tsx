  ...
  return (
    <Card className="rounded-3xl">
      <div className="flex items-center gap-4 p-6">
        ...
        <div>
          <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-50">{profile.name}</h1>
          <p className="text-sm text-gray-600 dark:text-gray-300">{profile.email}</p>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-4 border-t border-gray-200 p-6 dark:border-gray-700 sm:grid-cols-4">
